...
class Handlers {
    ...
    static public function Application($app, $return = NULL)
    {
        ...
        $tpl_app = \kernel\Mos::$config['TplDirectory'].\kernel\Mos::$config['DefaultTemplate'].'/'.$app.'.tpl';
    ...
    static public function Template($tpl, $param=NULL)
    {
        ...
        $dir = \kernel\Mos::$config['TplDirectory'];
        
        self::$template['connector'] = \kernel\Mos::$config['CacheDirectory'].'tpls/appconectors/'.$tpl.'_appconnector.php';
        self::$template['cacheFile'] = \kernel\Mos::$config['CacheDirectory'].'tpls/'.$tpl.'_index';
            ...
            {   
                ...
                foreach ($lines as $line_num => $line) {
                    ...
                    elseif(preg_match('/\{\{APP_(\w+)\}\}/i', $line, $matches, PREG_OFFSET_CAPTURE))
                    {
                        ...
                        $app_tpl_file = \kernel\Mos::$config['TplDirectory'].$app.'.tpl';
