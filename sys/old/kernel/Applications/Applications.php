...
class Applications {
    ...
    {
        $config_file = \kernel\Mos::$setting['kernel']['ConfDirectory'].$config_name.'.conf';
    ...
    {
        $app_file = \kernel\Mos::$setting['kernel']['AppDirectory'].$app_name;
        $app_format_file = '.php';
    ...
    static public function template($app)
    {
        ...
        $tpl_file = \kernel\Mos::$setting['kernel']['TplDirectory'].\kernel\Mos::$setting['kernel']['DefaultTemplate'].'/'.$app.'.tpl';
        
        $cache_file = \kernel\Mos::$setting['kernel']['CacheDirectory'].'tpls/apps/'.$app;
